              ...
              <div class="box-body">
                <section class="invoice">
                  ...
                  <div class="row invoice-info">
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                      <b>Quotation : <?php echo $quotation_details->quotation_text_prefix.'.'.$total_quotation; ?></b><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-6 col-xs-12">
                      ...
                      <div id="done_btn" class="hidden pull-right">
                        ...
                        <button type="button" class="btn btn-primary" onclick="$('#summary').removeClass('hidden');$('#done_btn').hide();$('#product_id_div select').attr('disabled',true);$('#submitbtn').removeClass('hidden');">Yes</button>
