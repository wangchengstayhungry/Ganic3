<section class="content-header">
  ...
  {
  echo "Confirmed Quotation List";
  }
  else
  echo ucwords($this->uri->segment(3))." Quotation List";
  ...
  if($this->uri->segment(3)=="confirm")
  {
    $list = array('active'=>ucwords('Confirmed Quotation List'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Quotation List');
  }
