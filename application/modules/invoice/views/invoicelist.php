<section class="content-header">
  ...
  {
  echo "Confirmed Invoice List";
  }
  else
  echo ucwords($this->uri->segment(3))." Invoice List";
  ...
  if($this->uri->segment(3)=="confirm")
  {
    $list = array('active'=>ucwords('Confirmed Invoice List'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Invoice List');
  }
