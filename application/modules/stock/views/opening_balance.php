                    ...
                    <table class="table" id="open_table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <input type="text" id="stock_code_id[0]" class="stock_code form-control" name="data[stock_code][0]">
                          </td>
                          <td>
                            <input type="text" id="stock_des_id[0]" class="stock_description form-control" name="data[stock_description][0]">
                          </td>
                          <td>
                            <input type="text" id="uom_id[0]" class="UOM form-control" name="data[uom][0]">
                          </td>
                          <td>
