          ...
          <form autocomplete="off" class="form-horizontal validate box-body" method="post" action="<?php echo $save_url; ?>">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="quotation_text_prefix" value="<?php if(!is_null($quotation_details)){echo $quotation_details->quotation_text_prefix;} ?>" name="quotation_text_prefix" placeholder="Text Prefix" class="form-control input-md" type="text">
                </div>
                <!-- ============================================================================= -->
                <label class="col-md-2 control-label" for="quotation_number_prefix">Number Prefix : </label>  
                <div class="col-md-4">
                <input id="quotation_number_prefix" value="<?php if(!is_null($quotation_details)){echo $quotation_details->quotation_number_prefix;} ?>" name="quotation_number_prefix" placeholder="Number Prefix" class="form-control input-md" type="number">
                </div>
              </div>

              <div class="form-group">
                <label class="col-md-2 control-label" for="quotation_type">Quotation Type : </label>  
                <div class="col-md-4">
