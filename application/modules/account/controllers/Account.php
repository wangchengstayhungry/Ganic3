...
// }
		...
		public function offsetRecords()
		{
            ...
            $this->db->trans_start();
			$ar[]=$this->custom->updateRow("accounts_receivable",array('offset'=>"o"),array('customer_code'=>$cus_code, 'offset'=>'n', 'doc_date <='=>$date_to_offset, 'settled'=>'y'));
