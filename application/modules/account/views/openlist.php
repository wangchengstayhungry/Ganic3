<section class="content-header">
  ...
  {
  echo "Confirmed Opening Balance List";
  }
  else
  echo ucwords($this->uri->segment(3))." Opening Balance List";
  ...
  if($this->uri->segment(3)=="confirm")
  { 
    $list = array('active'=>ucwords('Confirmed Opening Balance List'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Opening Balance List');
  }
